...
export const register_model = (payload) => {
  let endpoint = "https://casting-app-thdg.onrender.com/talents/register";
  ...
  return async (dispatch) => {
    try {
      const response = await axios.put(
        "https://casting-app-thdg.onrender.com/forms/companies",
        {
          email,
          name,
          logo,
...
export const register_company = (payload) => {
  let endpoint = "https://casting-app-thdg.onrender.com/companies/register";
  return async (dispatch) => {
    try {
      const response = await axios.post(endpoint, payload);
      return dispatch({
...
export const get_company_by_id = (id) => {
  let endpoint = `https://casting-app-thdg.onrender.com/companies/${id}`;
  return async (dispatch) => {
    try {
...
export const get_event_by_id = (id) => {
  let endpoint = `https://casting-app-thdg.onrender.com/events/${id}`;
  return async (dispatch) => {
    try {
      const { data } = await axios.get(endpoint);
      return dispatch({
...
export const get_event_by_id_event = (id) => {
  let endpoint = `https://casting-app-thdg.onrender.com/events/eventid/${id}`;
  return async (dispatch) => {
    try {
      const { data } = await axios.get(endpoint);
      return dispatch({
...
export const getEventsPremium = () => {
  return async (dispatch) => {
    try {
      const response = await axios.get("https://casting-app-thdg.onrender.com/events/premium");
...
export const edit_event_by_id = (id) => {
  return async (dispatch) => {
    try {
      const response = await axios.put(`https://casting-app-thdg.onrender.com/events/${id}`);
...
export const close_event_by_id = (id, companyId) => {
  return async (dispatch) => {
    try {
      await axios.delete(`https://casting-app-thdg.onrender.com/events/${id}`);
      const eventDetail = await axios.get(
        `https://casting-app-thdg.onrender.com/events/${companyId}`
      );
...
export const getAllCompanies = () => {
  return async (dispatch) => {
    try {
      const response = await axios.get("https://casting-app-thdg.onrender.com/companies");
  ...
  return async (dispatch) => {
    try {
      const response = await axios.get(
        `https://casting-app-thdg.onrender.com/applied/event/${fk}`
      );
...
export const get_postulant_by_name = (fk, name) => {
  let endpoint = `https://casting-app-thdg.onrender.com/applied/company/${fk}/?name=${name}`;
...
export const delete_postulant_by_id = (id_evento, id_talent) => {
  let endpoint = "https://casting-app-thdg.onrender.com/applied";
  return async (dispatch) => {
    try {
...
export const get_talent_by_id = (id) => {
  let endpoint = `https://casting-app-thdg.onrender.com/talents/${id}`;
  return async (dispatch) => {
    try {
      const { data } = await axios.get(endpoint);
      //console.log(data);
...
export const get_hired_by_company = (id) => {
  let endpoint = `https://casting-app-thdg.onrender.com/applied/hired/${id}`;
  //console.log('soy id');
  return async (dispatch) => {
    try {
      const { data } = await axios.get(endpoint);
...
export const getAllTalents = () => {
  let endpoint = "https://casting-app-thdg.onrender.com/talents/";
  return async (dispatch) => {
    try {
  ...
  return async (dispatch) => {
    try {
      let response = await axios.get(
        "https://casting-app-thdg.onrender.com/events/?name=" + name
      );
...
export const get_event_by_name = (name) => {
  return async (dispatch) => {
    try {
      let response = await axios.get(
        `https://casting-app-thdg.onrender.com/events//eventsName/${name}`
      );
...
export const get_all_favorite_postulants = (id) => {
  return async (dispatch) => {
    try {
      const response = await axios.get(
        `https://casting-app-thdg.onrender.com/companies/favorites/${id}`
      );
      //console.log(response.data);
...
export const get_favorite_postulant_by_name = (id, name) => {
  return async (dispatch) => {
    try {
      //PROBAR LA RUTA
      let response = await axios.get(
        `https://casting-app-thdg.onrender.com/companies/favorites/${id}/?name=${name}`
      );
      //console.log(response + 'estoy en action');
      return dispatch({
...
export const add_and_delete_favorite_postulant = (id_talent, id_company) => {
  ...
  let endpoint = "https://casting-app-thdg.onrender.com/companies/favorites";
  return async (dispatch) => {
    try {
      const { data } = await axios.post(endpoint, {
        TalentId: id_talent,
      ...
      const allFavorites = await axios.get(
        `https://casting-app-thdg.onrender.com/companies/favorites/${id_company}`
      );
      return dispatch({
...
export const get_all_postulants_contacted_by_id = (id) => {
  return async (dispatch) => {
    try {
      const response = await axios.get(
        `https://casting-app-thdg.onrender.com/applied/contacted/${id}`
      );
      //console.log(response.data);
      return dispatch({
...
export const add_hired = (id_talent, id_company, id_event) => {
  let response = {};
  let endpoint = "https://casting-app-thdg.onrender.com/applied/hire";
  return async (dispatch) => {
    try {
      ...
      const allPostulantsContacted = await axios.get(
        `https://casting-app-thdg.onrender.com/applied/contacted/${id_company}`
      );
...
export const update_plan = (id_company, plan) => {
  let endpoint = `https://casting-app-thdg.onrender.com/companies/plan/${id_company}`;
  return async (dispatch) => {
    try {
...
export const add_postulant_like_contacted = (
  ...
  //console.log(id_talent);
  //console.log(id_event);
  let endpoint = "https://casting-app-thdg.onrender.com/applied/contact";
  return async (dispatch) => {
    try {
  ...
  return async (dispatch) => {
    try {
      const response = await axios.post(
        `https://casting-app-thdg.onrender.com/companies/reviews${EventId, TalentId, rating, text}`
      );
