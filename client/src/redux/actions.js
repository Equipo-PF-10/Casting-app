...
export const updateCompany = (
  ...
  ) => 
  {
    return async (dispatch) => {
    try {
      const response = await axios.put("https://deploy-sprint-2-backend.onrender.com/forms/companies", {
        email,
        name,
        logo,
        country,
...
export const close_event_by_id = (id, companyId) => {
  return async (dispatch) => {
    try {
      ...
      const eventDetail = await axios.get(`https://deploy-sprint-2-backend.onrender.com/events/${companyId}`);
...
export const get_all_favorite_postulants = (id) => {
  return async (dispatch) => {
    try {
      const response = await axios.get(`https://deploy-sprint-2-backend.onrender.com/companies/favorites/${id}`);
      //console.log(response.data);
...
export const get_favorite_postulant_by_name = (id, name) => {
  return async (dispatch) => {
    try {                    //PROBAR LA RUTA
      let response = await axios.get(`https://deploy-sprint-2-backend.onrender.com/companies/favorites/${id}/?name=${name}`);
      //console.log(response + 'estoy en action');
      return dispatch({
...
export const add_and_delete_favorite_postulant=(id_talent,id_company) => {
  ...
  return async (dispatch) => {
    try {
      ...
      const allFavorites = await axios.get(`https://deploy-sprint-2-backend.onrender.com/companies/favorites/${id_company}`);
      return dispatch({
...
export const get_all_postulants_contacted_by_id = (id) => {
  return async (dispatch) => {
    try {
      const response = await axios.get(`https://deploy-sprint-2-backend.onrender.com/applied/contacted/${id}`);
      //console.log(response.data);
...
export const add_hired = (id_talent, id_company, id_event) => {
  ...
  return async (dispatch) => {
    try {
      ...
      const allPostulantsContacted = await axios.get(`https://deploy-sprint-2-backend.onrender.com/applied/contacted/${id_company}`);
...
export const refuse_postulant_contacted = (id_talent, id_company, id_event) => {
  ...
  return async (dispatch) => {
    try {
      ...
      let allPostulantsContacted = await axios.get(`https://deploy-sprint-2-backend.onrender.com/applied/contacted/${id_company}`);
      return dispatch({
...
export const add_postulant_like_contacted = (id_talent, id_company, id_event) => {
  ...
  return async (dispatch) => {
    try {
      ...
      let fk = id_event;
      let allPostulantsContacted = await axios.get(`https://deploy-sprint-2-backend.onrender.com/applied/event/${fk}`);
      return dispatch({
