      ...
      const getUserMetadata = async () => {
        ...
        try {
          ...
          if (isAuthenticated) {
            ...
            const validation = await axios.get(`https://casting-app-thdg.onrender.com/companies/email/${email}`)
            ...
            //? 3.2) si el mail no existe en la base de datos de talentos crea o encuentra en BD de compañias
              ...
              const register = await axios.post("https://casting-app-thdg.onrender.com/talents/register", {email,name,image})
              localStorage.setItem("user_id", `${register.data.id}`);
              
              const emailToTalent = axios.post(`https://casting-app-thdg.onrender.com/email/registerTalent/${email}`) 
      ...
      const getUserMetadata = async () => {
        ...
        try {
          ...
          if (isAuthenticated) {
            ...
            const validation = await axios.get(`https://casting-app-thdg.onrender.com/talents/email/${email}`)
            ...
            //? 3.2) si el mail no existe en la base de datos de talentos crea o encuentra en BD de compañias
              ...
              const register=await axios.post("https://casting-app-thdg.onrender.com/companies/register",{email,name,image,})
              console.log(register.data.id);
              localStorage.setItem("user_id", `${register.data.id}`);

              const emailToCompany = axios.post(`https://casting-app-thdg.onrender.com/email/registerCompany/${email}`)
                .then((resp) => console.log(resp.data))
                .catch((error) => console.log(error));
