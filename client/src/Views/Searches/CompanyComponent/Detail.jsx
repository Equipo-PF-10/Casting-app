...
const Detail = (props) => {
  ...
  const onClickRefuseTalent = (id_talent) => {
    ...
    const emailToTalent = axios.post(`https://casting-app-thdg.onrender.com/email/talentContacRefused/${talent.email}`)
    .then((resp) => console.log(resp.data))
    .catch((error) => console.log(error));

    const contacRefusedForCompany = axios.post(`https://casting-app-thdg.onrender.com/email/talentContacRefusedForCompany/${localStorage.getItem("user_email")}`)
    .then((resp) => console.log(resp.data))
    .catch((error) => console.log(error));
  };
    ...
    const onClickSendEmail = () => {
      ...
      const emailToTalent2 = axios.post(`https://casting-app-thdg.onrender.com/email/talentContac/${talent.email}`)
      .then((resp) => console.log(resp.data))
      .catch((error) => console.log(error));

      const contactTalentForCompany = axios.post(`https://casting-app-thdg.onrender.com/email/talentContacForCompany/${localStorage.getItem("user_email")}`)
    .then((resp) => console.log(resp.data))
    .catch((error) => console.log(error));
