...
export const loginControler = async (email, password) => {
  try {
    ...
    const isTalent = (await axios("https://deploy-sprint-2-backend.onrender.com/talents")).data;
    let access = false;
    ...
    const isCompany = (await axios("https://deploy-sprint-2-backend.onrender.com/companies")).data;
