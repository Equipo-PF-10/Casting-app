...
export default function PaymentPlans() {
  ...
  const handleCardClick = (plan) => {
    if (!planFreeUtilizado || plan !== 'Free') {
  ...
  return (
    <div className={styles.container}>
      ...
      {modalPlanFree && !planFreeUtilizado ? (
        <div className={styles.containerModalOpened}>
          <div className={styles.modalOpened}>
            ...
            <div className={styles.card.Free}>
              <ul>
      ...
      <h4
          className={
            selectedPlan === "Free" ? `${styles.selectedh4} ${styles.Free}` : ""
          }
        ...
        <h4
          className={
            selectedPlan === "Básico"
              ? `${styles.selectedh4} ${styles.Básico}`
              : ""
          }
        ...
        <h4
          className={
            selectedPlan === "Premium"
              ? `${styles.selectedh4} ${styles.Premium}`
              : ""
          }
      ...
      <div className={styles.bottomSection}>
        {/* <div
          className={`${styles.card} ${selectedPlan === 'Free' && planFreeUtilizado ? styles.selected : 'Free'} ${planFreeUtilizado ? styles.disabled : ''
            }`}
          onClick={() => handleCardClick('Free')}
        > */}
          <div
          className={`${styles.card} ${
            selectedPlan === "Free" ? styles.Free : ""
          } ${
            selectedPlan === "Básico" ? styles.Básico : ""
          } ${selectedPlan === "Premium" ? styles.Premium : ""}`}
          onClick={() => handleCardClick("Free")}
        >
        ...
        <div className={`${styles.card} ${selectedPlan === 'Básico' ? styles.Basico : ''
          }`} onClick={() => handleCardClick('Básico')}>
        ...
        <div className={`${styles.card} ${selectedPlan === 'Premium' ? styles.Premium : ''
          }`} onClick={() => handleCardClick('Premium')}>
