...
export default function PaymentPlans() {
  ...
  //Cuando infoCompany.planFree es true se deshabilita la card de Prueba Gratis
  const isPlanFreeDisabled = infoCompany.planFree;
  ...
  const handleConfirmPlanFree = () => {
    ...
    const emailToCompany = axios.post(`https://deploy-sprint-2-backend.onrender.com/email/suscriptionFree/${infoCompany.email}`)
        ...
        <div className={styles.containerModalOpened}>
          <div className={styles.modalOpened}>
            ...
            <div className={styles.head2}>
              <h2>
                Plan Seleccionado: <span>Plan Básico</span>
              </h2>
              <hr />
            </div>
            ...
            <div className={styles.features}>
              <ul>
                <li>
                  Tiene la posibilidad de publicar hasta 2 oportunidades
                  laborales de forma gratuita para empezar a dar a conocer tu
                  Empresa.
                </li>
                <li>
                  Recibe alertas por correo electrónico cuando se postulen
                  candidatos a tus empleos.
                </li>
                <li>
                  Explora nuestra plataforma y conoce todas las funcionalidades
                  de la misma.
                </li>
              </ul>
            </div>
            <div className={styles.cost}>
              <h2>
                Costo: 0<span>Plan Gratuito</span>
              </h2>
            </div>
          ...
          <div className={styles.modalConfirmationOpened}>
            ...
            <div className={styles.bottom3}>
              ...
              <button
                ...
                onClick={handleConfirmPlanFree}
              >
                Confirmar
              </button>
              <button
                className={styles.buttonRegresar}
                onClick={onClickCloseModalConfirmation}
              >
                Regresar
              </button>
            </div>
      ...
      <div className={styles.middleSection}>
        <div className={styles.intro}>
          ...
          <p>
            ...
            completa, con herramientas avanzadas de búsqueda y filtrado,
            destacando sus vacantes y una mayor visibilidad para atraer talentos
            de alto nivel. Nuestros planes permiten a las empresas personalizar
            su experiencia y aprovechar al máximo nuestra plataforma,
            encontrando el talento perfecto de manera eficiente y a un precio
            justo.
          </p>
        </div>
      </div>
