  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (Number(empresa.numberPosts) <= Number(empresa.conditionPlan)) {
        axios
          .post(`https://deploy-sprint-2-backend.onrender.com/email/companyNewEvent/${empresa.email}`)
      ...
      if (
        ...
        axios
          .post(`https://deploy-sprint-2-backend.onrender.com/email/stopAdd/${empresa.email}`)
          .then((resp) => console.log(resp.data))
          .catch((error) => console.log(error));
      }
      if (Number(empresa.numberPosts) + 1 === Number(empresa.conditionPlan)) {
        axios
          .post(`https://deploy-sprint-2-backend.onrender.com/email/stop/${empresa.email}`)
          .then((resp) => console.log(resp.data))
          .catch((error) => console.log(error));
      }
