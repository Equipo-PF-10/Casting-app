...
const EventUpdate = () => {
    ...
    const URL = `https://casting-app-thdg.onrender.com/events/${id}`;
    ...
    const handleSubmit = async (event) => {
        ...
        // const emailToCompany = axios.post(`https://casting-app-thdg.onrender.com/email/handlerCompanyEditedEvent/${empresa.email}`)
