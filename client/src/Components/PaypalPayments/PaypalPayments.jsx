...
const PaypalPayments = (props) => {
  ...
  return (
    <PayPalButtons
      ...
      onApprove={(data, actions) => {
        ...
        if (PLAN_TYPE === "PREMIUM") {
          axios
            .post(
              `https://casting-app-thdg.onrender.com/email/suscriptionPremium/${localStorage.getItem("user_email")}`)
            .then((resp) => console.log(resp.data))
            .catch((error) => console.log(error));
        } else if (PLAN_TYPE === "BASICO") {
          axios
            .post(`https://casting-app-thdg.onrender.com/email/suscriptionPro/${localStorage.getItem("user_email")}`)
            .then((resp) => console.log(resp.data))
            .catch((error) => console.log(error));
        } else {
    ...
    if (PLAN_TYPE === "PREMIUM") {
      axios.post('https://casting-app-thdg.onrender.com/payments', {
