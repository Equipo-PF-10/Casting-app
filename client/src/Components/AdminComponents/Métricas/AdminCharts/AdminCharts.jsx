...
const AdminCharts = () => {
    ...
    useEffect(() => {
        axios('https://casting-app-thdg.onrender.com/admin/companies/posts').then(({ data }) => {
            setcompaniesPostsData(data);
        })
        axios('https://casting-app-thdg.onrender.com/admin/companies/premium/1').then(({ data }) => {
            setProPlanData(data);
        })
        axios('https://casting-app-thdg.onrender.com/admin/companies/basico/1').then(({ data }) => {
            setPremiumPlanData(data);
        })
        axios('https://casting-app-thdg.onrender.com/admin/companies/prueba-gratis/1').then(({ data }) => {
            setFreePlanData(data);
        })
        axios('https://casting-app-thdg.onrender.com/admin/users/talents/1/12').then(({ data }) => {
        ...
        axios('https://casting-app-thdg.onrender.com/admin/users/companies/1/12').then(({ data }) => {
        ...
        axios('https://casting-app-thdg.onrender.com/admin/users/talents/male').then(({ data }) => {
            setMaleTalentsData(data);
        })
        axios('https://casting-app-thdg.onrender.com/admin/users/talents/female').then(({ data }) => {
            setFemaleTalentsData(data);
        })
        axios('https://casting-app-thdg.onrender.com/admin/users/available/talents').then(({ data }) => {
            setAvailableTalentsData(data);
        })
        axios('https://casting-app-thdg.onrender.com/admin/users/available/companies').then(({ data }) => {
            setAvailableCompaniesData(data);
        })
        axios('https://casting-app-thdg.onrender.com/payments').then(({ data }) => {
            setPaymentsData(data);
        })
        axios('https://casting-app-thdg.onrender.com/admin/users/banned/companies').then(({ data }) => {
