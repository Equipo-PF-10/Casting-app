...
const EmpresasAdmin = () => {
  ...
  const [input, setInput] = useState("");
    ...
    const handleBan = (id) => {
      axios.delete(`https://casting-app-thdg.onrender.com/admin/users/ban/companies/${id}`).then(() => {
        axios('https://casting-app-thdg.onrender.com/companies').then(({ data }) => {
    ...
    const handleUnban = (id) => {
      axios.patch(`https://casting-app-thdg.onrender.com/admin/users/desban/companies/${id}`).then(() => {
        axios('https://casting-app-thdg.onrender.com/companies').then(({ data }) => {
            setCompaniesData(data);
        })
        axios('https://casting-app-thdg.onrender.com/admin/users/banned/companies').then(({ data }) => {
