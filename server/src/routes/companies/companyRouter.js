...
const { handleSearchByLocation, handleCreateCompany, handleGetAllCompanies, handleUpdateCompanyById, handleGetCompanyById, handlerDeleteCompanyById } = require("../../handlers/companies/companiesHandler");
...
//? Esta ruta elimina por completo una compañia por id en la base de datos.
companyRouter.get("/", handleGetAllCompanies);
